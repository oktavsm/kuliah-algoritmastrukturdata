...
public class Solution2 {
    public static void main(String[] args) {
        ...
        System.out.println("Connected graph adjacency matrix (forward):");
        c.print();
        System.out.println("Total cost (forward): " + cost);
        System.out.println("Connected graph adjacency matrix (backward):");
        c2.print();
        System.out.println("Total cost (backward): " + cost2);
    }
}
